...
var config = require('../configurations/config.dev.json');
var path = require('path');
var _a = require('./utils'), handleFileValidation = _a.handleFileValidation, getImageAllowedFormats = _a.getImageAllowedFormats, getDocsAllowedFormats = _a.getDocsAllowedFormats;
module.exports = function (server, fileController, staticF) { return __awaiter(_this, void 0, void 0, function () {
